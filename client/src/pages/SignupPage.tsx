...
function SignupPage() {
  ...
  const [signupInform, setSignupInform] = useState({ email: '', nickname: '', password: '', passwordCheck: '' })
      ...
      <form className="signup_main_div" onSubmit={event => handleSignup(event)}>
        ...
        <div className="signup_nickname_div">
          ...
          <div>
            <input
              ...
              onBlur={e => handleInputValue(e, 'nickname')}
            />
            <button className="signup_nickname_button" type="button" onClick={checkNickname}>
              중복체크
            </button>
          </div>
        ...
        <div className="signup_email_div">
          ...
          <div>
            <input
              ...
              type="text"
              placeholder="이메일"
              onBlur={e => handleInputValue(e, 'email')}
            />
            <button className="signup_email_button" type="button" onClick={checkEmail}>
              중복체크
            </button>
          </div>
        ...
        <div className="signup_password_div">
          ...
          <input
            ...
            type="password"
            placeholder="비밀번호"
            onBlur={e => handleInputValue(e, 'password')}
          />
        ...
        <div className="signup_passwordcheck_div">
          ...
          <input
            ...
            type="password"
            placeholder="비밀번호 확인"
            onBlur={e => handleInputValue(e, 'passwordCheck')}
          />
          {!isSamePassword && signupInform.passwordCheck.length > 0 ? (
            <span className="signup_passwordcheck_span hide">비밀번호가 일치하지 않습니다.</span>
          ) : null}
        </div>
        <button className="signup_signup_button" type="submit" onClick={event => handleSignup(event)}>
          가입하기
        </button>
      </form>
    </div>
